function project_contact_trials(varargin)
close all; clc;
...
contact_test_controller_impl( ...
    runtime_options.scenario, ...
...
parser = inputParser;
addParameter(parser, 'scenario', 'landing', @(value) ischar(value) || (isstring(value) && isscalar(value)));
...
runtime_options.scenario = char(runtime_options.scenario);
